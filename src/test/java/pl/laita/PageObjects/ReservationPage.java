...
public class ReservationPage {
	...
	static String oneWay_xpath = "/html/body/div/table/"
			+ "tbody/tr/td[2]/table/tbody/tr[4]/td/table/tbody/tr/"
			+ "td[2]/table/tbody/tr[5]/td/form/table/"
	...
	static String ServClas_xpath = "/html/body/div/table/"
			+ "tbody/tr/td[2]/table/tbody/tr[4]/td/table/tbody/tr/td[2]/"
	...
	public void selectPassengersCount(WebDriver driver, String visibleText){
		Select passCount = new Select(driver.findElement(By.name(passCount_name)));
		passCount.selectByVisibleText(visibleText);
	}
